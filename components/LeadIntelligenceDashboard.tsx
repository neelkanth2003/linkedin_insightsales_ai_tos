...
import { Target, TrendingUp, ShieldAlert, CheckCircle, CalendarClock, Briefcase, Zap, X, Plus, Sparkles, Brain } from 'lucide-react';
...
const LeadIntelligenceDashboard: React.FC<Props> = ({ data, profile }) => {
