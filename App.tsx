...
export default function App() {
  ...
  useEffect(() => {
    // Set worker source for PDF.js - Handle potential default export structure from esm.sh
    const lib = pdfjsLib as any;
    // Use unpkg for a reliable worker source that avoids NetworkErrors with importScripts
